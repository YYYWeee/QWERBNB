  ...
  async up(queryInterface, Sequelize) {
    ...
    */
    ...
    return queryInterface.bulkInsert(options, [
      ...
      {//28
        ownerId: 2,
        address: '675 Lionshead Pl',
        city: 'Vail',
        state: 'Colorado',
        country: 'United States of America',
        lat: 39.64584671953084,
        lng: -106.38828029334287,
        name: '809 Potato Patch',
        description: 'Ski runs twine across peaks in the wide-open views from the hot tub at this Vail retreat. The tub burbles in a corner of one deck, flanked by outdoor seating; a second deck has a barbecue. Beams and black-framed windows make a modern statement in the great room, as do industrial-style lights over the kitchen island. It’s less than a 10-minute drive to both Lionshead and Vail Village parking.',
        price: 210
      },
      {//29
        ownerId: 2,
        ...
        state: 'Colorado',
        country: 'United States of America',
        lat: 39.631985008567796,
        lng: -106.41783362383602,
        name: 'Osprey',
        description: 'Nestled amongst snowy trees in the mountains of the Vail Valley, this spacious chalet is perfect for your next family ski getaway. After a long day on the slopes of Vail or Beaver Creek, return home for hot chocolates by the fire. Once you’ve reenergized, challenge one of the kids to a foosball or air hockey game. If you’re up for a night out, check out the bustling mountain nightlife in town.',
        price: 190
      },
      { //30
        ownerId: 2,
        address: '2048 St Joseph Dr NW',
        city: 'Cullman',
        state: 'Alabama',
        country: 'United States of America',
        lat: 34.20921356551054,
        lng: -86.87302640647417,
        name: 'WANDERLUST TREEHOUSE Book an experience!',
        description: 'CHECK IN DAYS MWF Our very unique treehouse is nestled into the treetops on 40 acres of forest. Great for a couples retreat, honeymoon, or spiritual reconnecting. Get away from it all and enjoy the nature trails and 2 acre lake(seasonal at times)to pass the time and be able to really unwind. Sit and enjoy your morning coffee outside on the deck as you may be able to catch a peak at the deer.',
        price: 110
      },
      { //31
        ownerId: 2,
        address: '62121 29 Palms Hwy',
        city: 'Joshua Tree',
        state: 'California',
        country: 'United States of America',
        lat: 34.13620135143596,
        lng: -116.30694345247949,
        name: 'The Kellogg Doolittle House',
        description: 'Kellogg, a former protege of Frank Lloyd Wright, has taken organic architecture to new levels with this outstanding house. The Kellogg-Doolittle House contains no straight lines or rectangular spaces. Instead, the house forms around 26-winged piers composed of organic material built quietly into the natural landscape: the kitchen and living room stretch softly around an unmoved, million-year-old rock formation, while the glass panels peek into a sprawl of sunrise and sunset views. ',
        price: 1110
      },
      { //32
        ownerId: 2,
        address: '76661 Palmeras Road',
        city: 'Indian Wells',
        state: 'California',
        country: 'United States of America',
        lat: 33.72197453958655,
        lng: -116.32683244793769,
        name: 'Buena Vista',
        description: 'The southern California desert gives way to a palm-ringed oasis at this Coachella Valley retreat. Part mid-century chic, with candy-striped umbrellas lining the pool, and part rustic charm, with a renovated barn and saloon-inspired bar, it also sits on a freshwater lake that’s ready for paddleboarding or kayaking. Drive 15 minutes to El Paseo for dining and shopping, or day trip to Palm Springs.',
        price: 810
      },
      { //33
        ownerId: 2,
        ...
        state: 'California',
        country: 'United States of America',
        lat: 34.11841939441354,
        lng: -118.33431032069784,
        name: 'Brentwood Villa',
        description: 'Three sprawling levels are yours to explore at this Brentwood mansion. Catch a flick in the cinema room, swim laps in the pool, or relax in the bubbling hot tub. The fabulous boutiques, restaurants, and museums of Los Angeles are mere moments away. Sip a cocktail on the rooftop terrace as the sunset dips behind the rippling ocean. A short drive lands you at Santa Monica’s famous pier and beach.',
        price: 510
      },
      { //34
        ownerId: 2,
        ...
        state: 'California',
        country: 'United States of America',
        lat: 34.07234054220217,
        lng: -118.26814797311403,
        name: 'SpaciousBohemianDreamhouse w/OutdoorSpace&KingBeds',
        description: 'Experience luxury in a spacious 4-bed, 3-bath, two-story home. Modern bohemian design with 2 living rooms, office, patio, fully equipped kitchen and a dining room. This home has: high-speed wifi, smart TVs, 3 king 1 queen beds, ample seating with 3 sofa couches, 2 wet bars, 2 fireplaces, AC, washer/dryer, parking spaces & more! Comfort is ensured. Relish in the private balcony, patio with backyard view. Ideal for relaxation, remote work, and making lasting memories. Book now and treat yourself!',
        price: 410
      },
      { //35
        ownerId: 2,
        address: '525 Flower St',
        city: 'Los Angeles',
        state: 'California',
        country: 'United States of America',
        lat:34.05410886698486 ,
        lng: -118.25852041502222 ,
        name: 'Spacious 4BR 2.5BA | Patio Lounge | Game Room!',
        description: 'This is a spacious 2-story home with a game room and cozy backyard and patio for you and your guests to enjoy. Your family will be close to everything when you stay at this centrally-located place. It is family friendly and well-behaved pets are welcomed. It is 5 minutes away from the interstate 10 freeway. Inside, make yourself at home with comfortable memory foam and hybrid beds in every room.',
        price: 310
      },
    ], { validate: true });
  },
